...
// Client wraps a go-redis client for application level helpers.
type Client struct {
	native *redis.Client
}

// New constructs a redis client and verifies connectivity with an initial PING.
...
// Close releases any redis resources held by the client.
