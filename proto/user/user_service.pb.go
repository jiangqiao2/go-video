...
const file_proto_user_service_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user_service.proto\x12\x04user\"3\n" +
	...
	"\x0fGetUsersByUUIDs\x12\x1c.user.GetUsersByUUIDsRequest\x1a\x1d.user.GetUsersByUUIDsResponseB\x0eZ\f./proto/userb\x06proto3"
